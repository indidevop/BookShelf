...
const BookSearch = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <h1 className="text-xl font-bold py-5">Search for Books</h1>
      <p className={`absolute ${display} top-10 lg:top-1 mx-auto ${status==="green"?"bg-green-400":"bg-red-400"} text-white py-1 px-2 text-sm rounded-md`}>{status==="green"?"Book added successfully":"Some error occured"}</p>
      <input
        type="text"
        value={query}
